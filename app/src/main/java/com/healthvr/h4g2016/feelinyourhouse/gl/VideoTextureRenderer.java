package com.healthvr.h4g2016.feelinyourhouse.gl;
...
public class VideoTextureRenderer extends TextureSurfaceRenderer implements SurfaceTexture.OnFrameAvailableListener
{
    ...
    private static float squareCoords[] = { -1.0f,  squareSize, 0.0f,   // top left
                                            -1.0f, -squareSize, 0.0f,   // bottom left
                                             0f, -squareSize, 0.0f,   // bottom right
                                             0f,  squareSize, 0.0f }; // top right
    private static float squareCoords2[] = { 0.0f,  squareSize, 0.0f,   // top left
